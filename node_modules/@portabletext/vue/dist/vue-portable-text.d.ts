...
export declare const PortableText: <B extends TypedObject = PortableTextBlock<PortableTextMarkDefinition, ArbitraryTypedObject | PortableTextSpan, string, string>>(__VLS_props: PortableTextProps<B> & VNodeProps & AllowedComponentProps & ComponentCustomProps, __VLS_ctx?: Pick<{
